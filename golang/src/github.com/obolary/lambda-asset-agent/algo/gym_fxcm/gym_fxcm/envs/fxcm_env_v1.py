  ...
  def _state(self,action):
    ...
    while not done:
      ...
      if zscore_fast != self.dataset_zscore_fast[-1]:
        ...
        if len( self.dataset_zscore_fast ) > self.dataset_window_fast:
    ...
    self.dataset_zscore_fast = self.dataset_zscore_fast[ -self.dataset_window_fast: ]
