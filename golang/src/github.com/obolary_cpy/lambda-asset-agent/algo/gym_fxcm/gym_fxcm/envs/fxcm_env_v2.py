...
class FxcmEnvV2( gym.Env ):
  ...
  def __init__(self, **kwargs):
    ...
    self.dataset_window_fast = 240
    self.dataset_zscore_fast = np.array([0.])
    self.dataset_window_slow = 480
  ...
  def _state(self,action):
    ...
    self.dataset_zscore_fast = self.dataset_zscore_fast[ -self.dataset_window: ]
    return self.dataset_zscore_fast, False
  ...
  def _tick( self ):
    ...
    if self.dataset_index % 10000 == 0:
      print( 
        ...
        '| zscore:', self.dataset_zscore_fast[ -1 ],
