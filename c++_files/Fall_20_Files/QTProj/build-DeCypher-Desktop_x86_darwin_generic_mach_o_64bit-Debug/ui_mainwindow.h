...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        plainTextEdit->setGeometry(QRect(3, -1, 771, 311));
        ...
        widget->setGeometry(QRect(110, 650, 82, 53));
        verticalLayout_4 = new QVBoxLayout(widget);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        verticalLayout_4->setContentsMargins(0, 0, 0, 0);
        browseCipher = new QPushButton(widget);
        ...
        verticalLayout_4->addWidget(browseCipher);
        ...
        QObject::connect(pushButton, SIGNAL(clicked()), cipherTextEdit, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), plainTextEdit, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), Z_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), X_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), Y_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), W_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), V_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), U_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), T_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), S_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), R_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), Q_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), P_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), O_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), N_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), A_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), B_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), C_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), D_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), E_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), F_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), G_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), H_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), I_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), J_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), K_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), L_EditBox, SLOT(clear()));
        QObject::connect(pushButton, SIGNAL(clicked()), M_EditBox, SLOT(clear()));
